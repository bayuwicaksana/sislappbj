<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="TIPEAKTOR_List.aspx.cs" Inherits="CTIPEAKTOR_List" %>-->
<html>
<head>
<title>TIPE AKTOR</title>
...
<option value="KODETIPE" {$KODETIPE_searchfieldoption}>KODE TIPE</option>
...
{BEGIN AKTOR_dtable_column}
<td width=50 class="headerlist">&nbsp;</td>
{END AKTOR_dtable_column}
...
{BEGIN AKTOR_dtable_column}
<td align="center" valign=middle class=borderbody>
{BEGIN AKTOR_dtable_link}
<a  {$AKTOR_dtablelink_attrs}>AKTOR{BEGIN AKTOR_childcount}({$AKTOR_childnumber})
{END AKTOR_childcount}
</a>
{END AKTOR_dtable_link}
</td>
{END AKTOR_dtable_column}

{BEGIN KODETIPE_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODETIPE_style}>
{$KODETIPE_value}
</td>
