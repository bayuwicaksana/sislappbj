...
public partial class CDOKUMEN_Add : AspNetRunnerPage 
{
    ...
    private void CopyRecord()
    {
        ...
        if(Request["copyid1"] != null || Request["editid1"] != null)
        {
	        ...
	        {
                item = Data.DOKUMEN.FetchByID(Request["copyid1"]);
                isCopy = true;
	        }
	        else
	        {
                 item = Data.DOKUMEN.FetchByID(Request["editid1"]);
                        ...
                        //	clear key fields
	            defvalues["KODEDOKUMEN"] = item.KODEDOKUMEN;
        }
    ...
    private void BuildBody()
    {
	    ...
	    if(inlineedit != ADD_MODE.ADD_ONTHEFLY)
	    {
		    ...
		    body["begin"] = includes + 
		    "<form name=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"DOKUMEN_add.aspx\" " + onsubmit + ">" +
	    ...
	    else
	    {
		    ...
		    body["begin"]= "<form name=\"editform" + (string)Request["id"] + "\" encType=\"multipart/form-data\" method=\"post\" action=\"DOKUMEN_add.aspx\" " + onsubmit + " target=\"flyframe" + (string)Request["id"] + "\">" +
		    "<input type=hidden name=\"a\" value=\"added\">" + 
    ...
    private void Init()
    {
        ...
        if(inlineedit == ADD_MODE.ADD_INLINE)
        {
	        templatefile = "DOKUMEN_inline_add.aspx";
        }
        else
        {
	        templatefile = "DOKUMEN_add.aspx";
        }
    }
