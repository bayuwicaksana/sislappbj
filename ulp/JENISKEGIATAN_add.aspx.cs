...
public partial class CJENISKEGIATAN_Add : AspNetRunnerPage 
{
    ...
    private void BuildForm()
    {
        ...
        if(RequestAction == "added")
        {
	        ...
	        masterquery="mastertable=dbo%2EJENISKEGIATAN";
	        masterquery += "&masterkey1=" + this.Server.UrlEncode(item.KODEJENISKEGIATAN.ToString());
	        showDetailKeys["dbo.KELENGKAPAN"] = masterquery;
    ...
    private void CopyRecord()
    {
        ...
        if(Request["copyid1"] != null || Request["editid1"] != null)
        {
	        ...
	        {
                item = Data.JENISKEGIATAN.FetchByID(Request["copyid1"]);
                isCopy = true;
	        }
	        else
	        {
                 item = Data.JENISKEGIATAN.FetchByID(Request["editid1"]);
                        ...
                        //	clear key fields
	            defvalues["KODEJENISKEGIATAN"] = item.KODEJENISKEGIATAN;
        }
    ...
    private void BuildBody()
    {
	    ...
	    if(inlineedit != ADD_MODE.ADD_ONTHEFLY)
	    {
		    ...
		    body["begin"] = includes + 
		    "<form name=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"JENISKEGIATAN_add.aspx\" " + onsubmit + ">" +
	    ...
	    else
	    {
		    ...
		    body["begin"]= "<form name=\"editform" + (string)Request["id"] + "\" encType=\"multipart/form-data\" method=\"post\" action=\"JENISKEGIATAN_add.aspx\" " + onsubmit + " target=\"flyframe" + (string)Request["id"] + "\">" +
		    "<input type=hidden name=\"a\" value=\"added\">" + 
    ...
    private void Init()
    {
        ...
        if(inlineedit == ADD_MODE.ADD_INLINE)
        {
	        templatefile = "JENISKEGIATAN_inline_add.aspx";
        }
        else
        {
	        templatefile = "JENISKEGIATAN_add.aspx";
        }
    }
