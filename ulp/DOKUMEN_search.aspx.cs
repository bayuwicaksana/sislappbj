...
public partial class CDOKUMEN_Search : AspNetRunnerPage
{
    int mypage = 1;
    int id = 1;
    string key;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            BuildForm();
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\DOKUMEN_search.aspx", smarty));
    ...
    protected void BuildForm()
    {
        ...
        //	edit format
                editformats["KODEDOKUMEN"] = "Text field";
        // DESKRIPSI 
        opt = "";
        not = false;
        value = string.Empty;
    ...
    protected void BuildBody()
    {
        ...
        contents_block["begin"]="<form method=\"POST\"";
                contents_block["begin"] += "action=\"DOKUMEN_list.aspx\"" ;
