...
public partial class CKELENGKAPAN_List : AspNetRunnerPage 
{
    ...
    Data.KELENGKAPANCollection collection;
    ...
    protected void Page_Load( object sender,  System.EventArgs e)  
    {
        string output = string.Empty;
                        if (User != null && !string.IsNullOrEmpty("KELENGKAPAN"))
            {
                OwnerColumn = func.GetOwnerIDField("KELENGKAPAN");
            }
            ...
            output = func.BuildOutput(this, @"~\KELENGKAPAN_list.aspx", smarty);
    ...
    private void AddDisplayGridAttributes()
    {
        if(display_grid)
        {
            ...
            grid_block["begin"] = "<form method=\"POST\" action=\"KELENGKAPAN_list.aspx\" name=\"frmAdmin\" id=\"frmAdmin\">" +
        ...
        smarty.Add("recordspp_attrs","onchange=\"javascript: document.location='KELENGKAPAN_list.aspx?pagesize='+this.options[this.selectedIndex].value;\"");
    ...
    private void AddMasterDetailInfo()
    {
        ...
        //	include proper masterlist.aspx code
	        ...
	        string master = JENISKEGIATANMasterList.CreateMasterTableInfo("KELENGKAPAN", keys, this);
	        smarty.Add("showmasterfile",master);
	        smarty.Add("backtomaster_link",true);
	        smarty.Add("mastertable_short","JENISKEGIATAN");
        }
        ...
        //	include proper masterlist.aspx code
            string[] keys = new string[1];
            keys[1 - 1] = (string)this.Session[strTableName + "_masterkey1"];
	        string master = DOKUMENMasterList.CreateMasterTableInfo("KELENGKAPAN", keys, this);
	        smarty.Add("showmasterfile",master);
	        smarty.Add("backtomaster_link",true);
	        smarty.Add("mastertable_short","DOKUMEN");
        }
    }
    ...
    private void AddLinkAttributes()
    {
	    ...
	    smarty.Add("printlink_attrs","onclick=\"window.open('KELENGKAPAN_print.aspx','wPrint');return false;\"");
	    smarty.Add("printalllink_attrs","onclick=\"window.open('KELENGKAPAN_print.aspx?all=1','wPrint');return false;\"");
	    smarty.Add("export_link", allow_export);
	    smarty.Add("exportlink_attrs","onclick=\"window.open('KELENGKAPAN_export.aspx','wExport');return false;\"");
		...
		"return true;" +
	    "document.forms.frmAdmin.action='KELENGKAPAN_print.aspx';" +
	    "document.forms.frmAdmin.target='_blank';" +
	    "document.forms.frmAdmin.submit(); " +
	    "document.forms.frmAdmin.action='KELENGKAPAN_list.aspx'; " +
	    ...
	    "if(!$('input[@type=checkbox][@checked][@name^=selection]').length)" +
		    "return true;" +
	    "document.forms.frmAdmin.action='KELENGKAPAN_export.aspx';" +
	    "document.forms.frmAdmin.target='_blank';" +
	    "document.forms.frmAdmin.submit(); " +
	    "document.forms.frmAdmin.action='KELENGKAPAN_list.aspx';  " +
	    "document.forms.frmAdmin.target='_self';\"");
	    ...
	    smarty.Add("addlink_attrs","onClick=\"window.location.href='KELENGKAPAN_add.aspx'\"");
	    smarty.Add("inlineaddlink_attrs","href=\"KELENGKAPAN_add.aspx\" onclick=\"return inlineAdd(newrecord_id++);\"");
        ...
        smarty.Add("KODEDOKUMEN_fieldheadercolumn",true);
        smarty.Add("KODEDOKUMEN_fieldcolumn",true);
        smarty.Add("KODEDOKUMEN_fieldfootercolumn",true);
        ...
        smarty.Add("asearchlink_attrs","onclick=\"window.location.href='KELENGKAPAN_search.aspx';return false;\"");
        smarty.Add("import_link",allow_import);
        smarty.Add("importlink_attrs","onclick=\"window.location.href='KELENGKAPAN_import.aspx';return false;\"");
    ...
    private void BuildForm()
    {
	    ...
	    for(int i = 0; i < collection.Count; ++ i)
        {
                        ...
                        if(beforeProcessRowListResult)
            {
			    ...
			    masterquery = "mastertable=KELENGKAPAN";
			    masterquery += "&masterkey1=" + this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString());
                masterID = collection[i].KODEKELENGKAPAN.ToString();
                //detail tables
                ...
                {
                    if (masterID != null && details.KODEKELENGKAPAN.ToString() == masterID)
                    {
                        ++KELENGKAPANPBJ_cnt;
                    }
                }
            ...
            //	key fields
	            ...
	            editlink += "editid1=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString()));
	            copylink +="copyid1=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString()));
	            keylink +="&key1=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString()));

	            record["editlink_attrs"]="href=\"KELENGKAPAN_edit.aspx?" + editlink + "\" id=\"editlink" + recno.ToString() + "\"";
	            record["inlineeditlink_attrs"]= "href=\"KELENGKAPAN_edit.aspx?" + editlink + "\" onclick=\"return inlineEdit('" + recno.ToString() + "','" + editlink + "');\" id=\"ieditlink" + recno.ToString() + "\"";
	            record["copylink_attrs"]="href=\"KELENGKAPAN_add.aspx?" + copylink + "\" id=\"copylink" + recno.ToString() + "\"";
	            record["viewlink_attrs"]="href=\"KELENGKAPAN_view.aspx?"  + editlink + "\" id=\"viewlink" + recno.ToString() + "\"";
    ...
    //	KODEKELENGKAPAN - 
            ...
            value = string.Empty;
    //	KODEDOKUMEN - 
            Control control_KODEDOKUMEN = new Control("KODEDOKUMEN", collection[i].KODEDOKUMEN, false, smarty, this.Request, builder, MODE.MODE_LIST);
	                        //func.PopulateLookupFields(control_KODEDOKUMEN.FieldInfo);
			    value=func.GetLookupValue(control_KODEDOKUMEN.FieldInfo);
                control_KODEDOKUMEN.Value = value;
			    record["KODEDOKUMEN_value"]=value;
            value = string.Empty;
    //	KODEJENISKEGIATAN - 
    ...
    private void GetAdvancedSearchRows()
    {
        ...
        if(Mastertable=="JENISKEGIATAN")
        {
	        Asearchfor["KODEJENISKEGIATAN"] = (string)this.Session[strTableName + "_masterkey1"];
            par.Add("KODEJENISKEGIATAN", this.Session[strTableName + "_masterkey1"]);
        }
        if(Mastertable=="DOKUMEN")
        {
	        Asearchfor["KODEDOKUMEN"] = (string)this.Session[strTableName + "_masterkey1"];
            par.Add("KODEDOKUMEN", this.Session[strTableName + "_masterkey1"]);
        }
        string oCol = OwnerColumn;
        string oID = OwnerID;
    ...
    private void GetData()
    {
        ...
        {
            collection = new Data.KELENGKAPANCollection();
            numrows = 0;
        }
        else
        {
        ...
        {
            try{
            KELENGKAPANPBJ_masterids.Add(collection[i].KODEKELENGKAPAN.ToString());
            }
            catch
            {
            }
        }
        KELENGKAPANPBJ_detailCollection = KELENGKAPANPBJ_detailController.FetchForDetails("KODEKELENGKAPAN", KELENGKAPANPBJ_masterids.ToArray(), OwnerColumn, OwnerID);
        ...
        if(allow_search)
        {
	        ...
	        else
	        {
	            ...
	            if(maxpages > 1)
	            {
                    ...
                    pagination += "{window.location='KELENGKAPAN_list.aspx?goto=' + nPageNumber;}</script>";
    ...
    private void ProcessSessionVariables()
    {
        ...
        smarty.Add("KODEKELENGKAPAN_orderlinkattrs", "href=\"KELENGKAPAN_list.aspx?orderby=aKODEKELENGKAPAN\"");
        smarty.Add("KODEKELENGKAPAN_fieldheader", true);
        smarty.Add("KODEDOKUMEN_orderlinkattrs", "href=\"KELENGKAPAN_list.aspx?orderby=aKODEDOKUMEN\"");
        smarty.Add("KODEDOKUMEN_fieldheader", true);
        smarty.Add("KODEJENISKEGIATAN_orderlinkattrs", "href=\"KELENGKAPAN_list.aspx?orderby=aKODEJENISKEGIATAN\"");
        ...
        if(tmp_orderby != null)
        {
	        ...
	        smarty[Control.GoodFieldName(order_field) + "_orderlinkattrs"] = "href=\"KELENGKAPAN_list.aspx?orderby=" + dir + Control.GoodFieldName(order_field) + "\"";
    ...
    private void Body()
    {
        ...
        "<form name=\"frmSearch\" method=\"GET\" action=\"KELENGKAPAN_list.aspx\">" + 
    ...
    private string GetIncludes()
    {
	    ...
	    includes.Append("var INLINE_EDIT_TABLE='KELENGKAPAN_edit.aspx';\r\n");
	    includes.Append("var INLINE_ADD_TABLE='KELENGKAPAN_add.aspx';\r\n");
	    includes.Append("var INLINE_VIEW_TABLE='KELENGKAPAN_view.aspx';\r\n");
	    includes.Append("var SUGGEST_TABLE='KELENGKAPAN_searchsuggest.aspx';\r\n");
	    includes.Append("var MASTER_PREVIEW_TABLE='KELENGKAPAN_masterpreview.aspx';\r\n");
        includes.Append("\n</script>\n");
        ...
        private void ProcessMasterTableOptions()
    {
        ...
        else
        {
            ...
            if(mtable=="JENISKEGIATAN")
            {
                ...
                smarty.Add("backtomasterlink_attrs","href=\"JENISKEGIATAN_list.aspx?a=return\"");
            }
            if(mtable=="DOKUMEN")
            {
                	            Mastertable = mtable;
	            ...
	            smarty.Add("mastertable_block", true);
                smarty.Add("backtomasterlink_attrs","href=\"DOKUMEN_list.aspx?a=return\"");
            }
    }
