...
<html>
  <head>
    <title>View Anggota POKJA</title>
  ...
  <body MS_POSITIONING="GridLayout">
	...
	SqlConnection myConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        string ssql = "select NAMA from AKTORPOKJA inner join AKTOR on AKTORPOKJA.NIP=AKTOR.NIP where AKTORPOKJA.KODEPOKJA = '" + Request["usrgrp"] + "' and TAHUN = "+DateTime.Now.Year.ToString()+";";
