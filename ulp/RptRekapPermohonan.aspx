<%@ Page Language="VB" AutoEventWireup="true" CodeFile="RptRekapPermohonan.aspx.vb" Inherits="RptRekapPermohonan" MasterPageFile="~/Default.master" Title="REKAP PERMOHONAN LELANG"%>
<asp:Content ID="Content1" Runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <br />
    <div id="Msg" style="width: 100%;" runat="server"></div>
    <br />
