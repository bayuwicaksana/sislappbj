...
public partial class CTIPEAKTOR_Edit : AspNetRunnerPage 
{
    ...
    private void SaveData()
    {
        ...
        Data.TIPEAKTOR emptyItem = new Data.TIPEAKTOR();
        ...
        //
        //item.KODETIPE =  Convert.ToString(Request["editid1"]);
        //
        string idx = string.Empty;
        idx = "1";
                                               item.KODETIPE =  Convert.ToString(Request["editid" + idx]);
    ...
    private void BuildBody()
    {
		...
		body["begin"] = includes + 
		"<form name=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"TIPEAKTOR_edit.aspx\" " + onsubmit + ">" +
        ...
        body["begin"] +="<input type=\"hidden\" name=\"editid1\" value=\""+ Control.HTMLEncodeSpecialChars(keys["KODETIPE"].ToString()) + "\">";
	    	    smarty.Add("show_key1", Control.HTMLEncodeSpecialChars(control_KODETIPE.GetData()));
        ...
        showKeys.Add(Server.UrlEncode(keys["KODETIPE"].ToString()));
    }
