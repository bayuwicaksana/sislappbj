...
public partial class CJENISKEGIATAN_Search : AspNetRunnerPage
{
    int mypage = 1;
    int id = 1;
    string key;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            BuildForm();
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\JENISKEGIATAN_search.aspx", smarty));
    ...
    protected void BuildForm()
    {
        ...
        //	edit format
                editformats["KODEJENISKEGIATAN"] = "Text field";
        // DESKRIPSI 
        opt = "";
        not = false;
        value = string.Empty;
