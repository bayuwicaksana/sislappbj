<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="PENGGUNA_Search.aspx.cs" Inherits="CPENGGUNA_Search" %>-->
<html>
<head>
<title>PENGGUNA: Advanced search page</title>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">KODE PENGGUNA</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEPENGGUNA_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEPENGGUNA}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEPENGGUNA_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEPENGGUNA">
	{$KODEPENGGUNA_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KODEPENGGUNA_fieldblock}	
{BEGIN NAMA_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">NAMA PENGGUNA</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$NAMA_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_NAMA}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$NAMA_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_NAMA">
	{$NAMA_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END NAMA_fieldblock}	
...
<tr>
	<td class=editshade_b style="padding-left:15px;">KATA KUNCI</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KATAKUNCI_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KATAKUNCI}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KATAKUNCI_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KATAKUNCI">
	{$KATAKUNCI_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KATAKUNCI_fieldblock}	
{BEGIN KODEKELOMPOK_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">KELOMPOK PENGGUNA</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEKELOMPOK_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEKELOMPOK}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEKELOMPOK_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEKELOMPOK">
	{$KODEKELOMPOK_editcontrol1}
	</span>&nbsp;</td>
</tr>
