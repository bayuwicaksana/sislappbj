...
public partial class CSTATUSPBJ_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\STATUSPBJ_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
