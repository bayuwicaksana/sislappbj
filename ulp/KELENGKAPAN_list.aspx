<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELENGKAPAN_List.aspx.cs" Inherits="CKELENGKAPAN_List" %>-->
<html>
<head>
<title>KELENGKAPAN</title>
...
<option value="KODEDOKUMEN" {$KODEDOKUMEN_searchfieldoption}>DOKUMEN</option>
...
{BEGIN KODEDOKUMEN_fieldheadercolumn}
<td class="headerlist">
{BEGIN KODEDOKUMEN_fieldheader}
<a class="tablelinks" {$KODEDOKUMEN_orderlinkattrs}>
DOKUMEN</a>
{END KODEDOKUMEN_fieldheader}
</td>
{END KODEDOKUMEN_fieldheadercolumn}
...
<a  {$KELENGKAPANPBJ_dtablelink_attrs}>KELENGKAPAN PBJ{BEGIN KELENGKAPANPBJ_childcount}({$KELENGKAPANPBJ_childnumber})
...
{BEGIN KODEDOKUMEN_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODEDOKUMEN_style}>
{$KODEDOKUMEN_value}
</td>
{END KODEDOKUMEN_fieldcolumn}
{BEGIN KODEJENISKEGIATAN_fieldcolumn}
<td align=center valign=middle  {$KODEJENISKEGIATAN_style}>
