...
public partial class CASSIGNMENT_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\ASSIGNMENT_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
