...
public partial class CKELENGKAPANPBJ_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\KELENGKAPANPBJ_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
    ...
    {
        keys["KODEBPJ"] = Request["key1"];
        keys["KODEKELENGKAPAN"] = Request["key2"];
