...
public partial class CJENISKEGIATAN_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\JENISKEGIATAN_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
    ...
    {
        keys["KODEJENISKEGIATAN"] = Request["key1"];
