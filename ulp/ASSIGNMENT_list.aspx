<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="ASSIGNMENT_List.aspx.cs" Inherits="CASSIGNMENT_List" %>-->
<html>
<head>
...
<option value="NOSURATTUGAS" {$NOSURATTUGAS_searchfieldoption}>NO SURAT TUGAS</option>
<option value="NIP" {$NIP_searchfieldoption}>NAMA</option>
<option value="KODEPBJ" {$KODEPBJ_searchfieldoption}>KEGIATAN/PAKET</option>
</select>
...
{BEGIN add_link}
<span class=buttonborder><input type=button class="button" value="Cancel" {$addlink_attrs}></span>
{END add_link}
...
{BEGIN NOSURATTUGAS_fieldheadercolumn}
<td class="headerlist">
{BEGIN NOSURATTUGAS_fieldheader}
<a class="tablelinks" {$NOSURATTUGAS_orderlinkattrs}>
NO SURAT TUGAS</a>
{END NOSURATTUGAS_fieldheader}
</td>
{END NOSURATTUGAS_fieldheadercolumn}
...
{BEGIN NOSURATTUGAS_fieldcolumn}
<td align=center valign=middle class=borderbody {$NOSURATTUGAS_style}>
{$NOSURATTUGAS_value}
</td>
{END NOSURATTUGAS_fieldcolumn}
...
<td align=center valign=middle  {$KODEPBJ_style}>
{$KODEPBJ_value}
</td>
