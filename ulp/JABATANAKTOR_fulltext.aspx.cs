...
public partial class CJABATANAKTOR_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\JABATANAKTOR_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
