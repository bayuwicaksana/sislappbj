<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="STATUSPBJ_List.aspx.cs" Inherits="CSTATUSPBJ_List" %>-->
<html>
<head>
<title>STATUS PBJ</title>
...
<option value="KODESTATUS" {$KODESTATUS_searchfieldoption}>KODE STATUS</option>
<option value="DESKRIPSI" {$DESKRIPSI_searchfieldoption}>DESKRIPSI</option>
<option value="URUTAN" {$URUTAN_searchfieldoption}>URUTAN</option>
</select>
...
{BEGIN KODESTATUS_fieldheadercolumn}
<td class="headerlist">
{BEGIN KODESTATUS_fieldheader}
<a class="tablelinks" {$KODESTATUS_orderlinkattrs}>
KODE STATUS</a>
{END KODESTATUS_fieldheader}
</td>
{END KODESTATUS_fieldheadercolumn}
{BEGIN DESKRIPSI_fieldheadercolumn}
<td class="headerlist">
{BEGIN DESKRIPSI_fieldheader}
<a class="tablelinks" {$DESKRIPSI_orderlinkattrs}>
DESKRIPSI</a>
{END DESKRIPSI_fieldheader}
</td>
{END DESKRIPSI_fieldheadercolumn}
{BEGIN URUTAN_fieldheadercolumn}
<td class="headerlist_right2">
{BEGIN URUTAN_fieldheader}
<a class="tablelinks" {$URUTAN_orderlinkattrs}>
URUTAN</a>
{END URUTAN_fieldheader}
</td>
{END URUTAN_fieldheadercolumn}
...
{BEGIN KODESTATUS_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODESTATUS_style}>
{$KODESTATUS_value}
</td>
{END KODESTATUS_fieldcolumn}
{BEGIN DESKRIPSI_fieldcolumn}
<td align=center valign=middle class=borderbody {$DESKRIPSI_style}>
{$DESKRIPSI_value}
</td>
{END DESKRIPSI_fieldcolumn}
{BEGIN URUTAN_fieldcolumn}
<td align=center valign=middle  {$URUTAN_style}>
{$URUTAN_value}
</td>
{END URUTAN_fieldcolumn}
<td>&nbsp;</td>
