...
public partial class CJABATANAKTOR_Search : AspNetRunnerPage
{
    int mypage = 1;
    int id = 1;
    string key;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            BuildForm();
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\JABATANAKTOR_search.aspx", smarty));
    ...
    protected void BuildForm()
    {
        ...
        //	edit format
                editformats["KODEJABATAN"] = "Text field";
        // DESKRIPSI 
        opt = "";
        not = false;
        value = string.Empty;
    ...
    protected void BuildBody()
    {
        ...
        contents_block["begin"]="<form method=\"POST\"";
                contents_block["begin"] += "action=\"JABATANAKTOR_list.aspx\"" ;
