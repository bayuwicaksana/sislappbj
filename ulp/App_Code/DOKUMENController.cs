...
{
    /// <summary>
    /// Controller class for DOKUMEN
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class DOKUMENController
    {
        // Preload our schema..
        DOKUMEN thisSchemaLoad = new DOKUMEN();
        ...
        public DOKUMENCollection FetchAll()
        {
            DOKUMENCollection coll = new DOKUMENCollection();
            Query qry = new Query(DOKUMEN.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private DOKUMENCollection GetPagedItems(DOKUMENCollection all, int startRowIndex, int maximumRows)
        {
            DOKUMENCollection items = new DOKUMENCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = DOKUMEN.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, DOKUMEN.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = DOKUMEN.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("DOKUMEN", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in DOKUMEN.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(DOKUMEN.Schema.TableName,
                ...
                {
                    qry.AddWhere(DOKUMEN.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(DOKUMEN.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = DOKUMEN.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(DOKUMEN.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = DOKUMEN.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByQuery(Query qry)
        {
            DOKUMENCollection coll = new DOKUMENCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            DOKUMENCollection coll = new DOKUMENCollection();
            Query qry = new Query(DOKUMEN.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public DOKUMENCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        DOKUMENCollection items = new DOKUMENCollection();
	        Query qry = new Query( DOKUMEN.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMEN FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new DOKUMEN();
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEDOKUMEN)
        {
            return DOKUMEN.FetchByParameter("KODEDOKUMEN", KODEDOKUMEN);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DOKUMENCollection FetchByID(object KODEDOKUMEN)
        {
            DOKUMENCollection coll = new DOKUMENCollection().Where("KODEDOKUMEN", KODEDOKUMEN).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEDOKUMEN)
        {
            return (DOKUMEN.Delete(KODEDOKUMEN) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEDOKUMEN)
        {
            return (DOKUMEN.Destroy(KODEDOKUMEN) == 1);
        }
