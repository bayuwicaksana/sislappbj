...
{
    /// <summary>
    /// Controller class for KELENGKAPAN
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class KELENGKAPANController
    {
        // Preload our schema..
        KELENGKAPAN thisSchemaLoad = new KELENGKAPAN();
        ...
        public KELENGKAPANCollection FetchAll()
        {
            KELENGKAPANCollection coll = new KELENGKAPANCollection();
            Query qry = new Query(KELENGKAPAN.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private KELENGKAPANCollection GetPagedItems(KELENGKAPANCollection all, int startRowIndex, int maximumRows)
        {
            KELENGKAPANCollection items = new KELENGKAPANCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = KELENGKAPAN.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, KELENGKAPAN.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = KELENGKAPAN.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("KELENGKAPAN", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new KELENGKAPANCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in KELENGKAPAN.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(KELENGKAPAN.Schema.TableName,
                ...
                {
                    qry.AddWhere(KELENGKAPAN.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(KELENGKAPAN.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = KELENGKAPAN.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(KELENGKAPAN.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = KELENGKAPAN.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByQuery(Query qry)
        {
            KELENGKAPANCollection coll = new KELENGKAPANCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            KELENGKAPANCollection coll = new KELENGKAPANCollection();
            Query qry = new Query(KELENGKAPAN.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public KELENGKAPANCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        KELENGKAPANCollection items = new KELENGKAPANCollection();
	        Query qry = new Query( KELENGKAPAN.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPAN FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new KELENGKAPAN();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEKELENGKAPAN)
        {
            return KELENGKAPAN.FetchByParameter("KODEKELENGKAPAN", KODEKELENGKAPAN);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANCollection FetchByID(object KODEKELENGKAPAN)
        {
            KELENGKAPANCollection coll = new KELENGKAPANCollection().Where("KODEKELENGKAPAN", KODEKELENGKAPAN).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEKELENGKAPAN)
        {
            return (KELENGKAPAN.Delete(KODEKELENGKAPAN) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEKELENGKAPAN)
        {
            return (KELENGKAPAN.Destroy(KODEKELENGKAPAN) == 1);
        }
