...
{
    /// <summary>
    /// Controller class for POKJA
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class POKJAController
    {
        // Preload our schema..
        POKJA thisSchemaLoad = new POKJA();
        ...
        public POKJACollection FetchAll()
        {
            POKJACollection coll = new POKJACollection();
            Query qry = new Query(POKJA.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private POKJACollection GetPagedItems(POKJACollection all, int startRowIndex, int maximumRows)
        {
            POKJACollection items = new POKJACollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = POKJA.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, POKJA.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = POKJA.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("POKJA", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in POKJA.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(POKJA.Schema.TableName,
                ...
                {
                    qry.AddWhere(POKJA.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(POKJA.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = POKJA.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(POKJA.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = POKJA.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByQuery(Query qry)
        {
            POKJACollection coll = new POKJACollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            POKJACollection coll = new POKJACollection();
            Query qry = new Query(POKJA.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public POKJACollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        POKJACollection items = new POKJACollection();
	        Query qry = new Query( POKJA.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJA FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new POKJA();
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEPOKJA)
        {
            return POKJA.FetchByParameter("KODEPOKJA", KODEPOKJA);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public POKJACollection FetchByID(object KODEPOKJA)
        {
            POKJACollection coll = new POKJACollection().Where("KODEPOKJA", KODEPOKJA).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEPOKJA)
        {
            return (POKJA.Delete(KODEPOKJA) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEPOKJA)
        {
            return (POKJA.Destroy(KODEPOKJA) == 1);
        }
