...
{
    /// <summary>
    /// Controller class for KELENGKAPANPBJ
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class KELENGKAPANPBJController
    {
        // Preload our schema..
        KELENGKAPANPBJ thisSchemaLoad = new KELENGKAPANPBJ();
        ...
        public KELENGKAPANPBJCollection FetchAll()
        {
            KELENGKAPANPBJCollection coll = new KELENGKAPANPBJCollection();
        ...
        private KELENGKAPANPBJCollection GetPagedItems(KELENGKAPANPBJCollection all, int startRowIndex, int maximumRows)
        {
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = KELENGKAPANPBJ.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, KELENGKAPANPBJ.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = KELENGKAPANPBJ.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("KELENGKAPANPBJ", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new KELENGKAPANPBJCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in KELENGKAPANPBJ.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(KELENGKAPANPBJ.Schema.TableName,
                ...
                {
                    qry.AddWhere(KELENGKAPANPBJ.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(KELENGKAPANPBJ.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = KELENGKAPANPBJ.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(KELENGKAPANPBJ.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = KELENGKAPANPBJ.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByQuery(Query qry)
        {
            KELENGKAPANPBJCollection coll = new KELENGKAPANPBJCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return KELENGKAPANPBJ.FetchAll();
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            KELENGKAPANPBJCollection coll = new KELENGKAPANPBJCollection();
            Query qry = new Query(KELENGKAPANPBJ.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public KELENGKAPANPBJCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        KELENGKAPANPBJCollection items = new KELENGKAPANPBJCollection();
	        Query qry = new Query( KELENGKAPANPBJ.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJ FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new KELENGKAPANPBJ();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEBPJ)
        {
            return KELENGKAPANPBJ.FetchByParameter("KODEBPJ", KODEBPJ);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELENGKAPANPBJCollection FetchByID(object KODEBPJ)
        {
            KELENGKAPANPBJCollection coll = new KELENGKAPANPBJCollection().Where("KODEBPJ", KODEBPJ).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEBPJ)
        {
            return (KELENGKAPANPBJ.Delete(KODEBPJ) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEBPJ)
        {
            return (KELENGKAPANPBJ.Destroy(KODEBPJ) == 1);
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(string KODEBPJ,string KODEKELENGKAPAN)
        {
            Query qry = new Query(KELENGKAPANPBJ.Schema);
