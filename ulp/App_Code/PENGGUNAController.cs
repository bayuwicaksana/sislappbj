...
{
    /// <summary>
    /// Controller class for PENGGUNA
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class PENGGUNAController
    {
        // Preload our schema..
        PENGGUNA thisSchemaLoad = new PENGGUNA();
        ...
        public PENGGUNACollection FetchAll()
        {
            PENGGUNACollection coll = new PENGGUNACollection();
        ...
        private PENGGUNACollection GetPagedItems(PENGGUNACollection all, int startRowIndex, int maximumRows)
        {
            PENGGUNACollection items = new PENGGUNACollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = PENGGUNA.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, PENGGUNA.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = PENGGUNA.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("PENGGUNA", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in PENGGUNA.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(PENGGUNA.Schema.TableName,
                ...
                {
                    qry.AddWhere(PENGGUNA.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(PENGGUNA.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = PENGGUNA.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(PENGGUNA.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = PENGGUNA.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByQuery(Query qry)
        {
            PENGGUNACollection coll = new PENGGUNACollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            PENGGUNACollection coll = new PENGGUNACollection();
            Query qry = new Query(PENGGUNA.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public PENGGUNACollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        PENGGUNACollection items = new PENGGUNACollection();
	        Query qry = new Query( PENGGUNA.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNA FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new PENGGUNA();
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEPENGGUNA)
        {
            return PENGGUNA.FetchByParameter("KODEPENGGUNA", KODEPENGGUNA);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGGUNACollection FetchByID(object KODEPENGGUNA)
        {
            PENGGUNACollection coll = new PENGGUNACollection().Where("KODEPENGGUNA", KODEPENGGUNA).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEPENGGUNA)
        {
            return (PENGGUNA.Delete(KODEPENGGUNA) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEPENGGUNA)
        {
            return (PENGGUNA.Destroy(KODEPENGGUNA) == 1);
        }
