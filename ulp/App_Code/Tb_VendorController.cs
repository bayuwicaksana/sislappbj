...
{
    /// <summary>
    /// Controller class for Tb_Vendor
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class Tb_VendorController
    {
        // Preload our schema..
        Tb_Vendor thisSchemaLoad = new Tb_Vendor();
        ...
        public Tb_VendorCollection FetchAll()
        {
            Tb_VendorCollection coll = new Tb_VendorCollection();
            Query qry = new Query(Tb_Vendor.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private Tb_VendorCollection GetPagedItems(Tb_VendorCollection all, int startRowIndex, int maximumRows)
        {
            Tb_VendorCollection items = new Tb_VendorCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = Tb_Vendor.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, Tb_Vendor.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = Tb_Vendor.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("Tb_Vendor", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new Tb_VendorCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in Tb_Vendor.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(Tb_Vendor.Schema.TableName,
                ...
                {
                    qry.AddWhere(Tb_Vendor.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(Tb_Vendor.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = Tb_Vendor.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(Tb_Vendor.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = Tb_Vendor.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByQuery(Query qry)
        {
            Tb_VendorCollection coll = new Tb_VendorCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            Tb_VendorCollection coll = new Tb_VendorCollection();
            Query qry = new Query(Tb_Vendor.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public Tb_VendorCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        Tb_VendorCollection items = new Tb_VendorCollection();
	        Query qry = new Query( Tb_Vendor.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_Vendor FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new Tb_Vendor();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KD_VENDOR)
        {
            return Tb_Vendor.FetchByParameter("KD_VENDOR", KD_VENDOR);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public Tb_VendorCollection FetchByID(object KD_VENDOR)
        {
            Tb_VendorCollection coll = new Tb_VendorCollection().Where("KD_VENDOR", KD_VENDOR).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KD_VENDOR)
        {
            return (Tb_Vendor.Delete(KD_VENDOR) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KD_VENDOR)
        {
            return (Tb_Vendor.Destroy(KD_VENDOR) == 1);
        }
