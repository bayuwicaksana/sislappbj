...
{
    /// <summary>
    /// Controller class for KELOMPOKPENGGUNA
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class KELOMPOKPENGGUNAController
    {
        // Preload our schema..
        KELOMPOKPENGGUNA thisSchemaLoad = new KELOMPOKPENGGUNA();
        ...
        public KELOMPOKPENGGUNACollection FetchAll()
        {
            KELOMPOKPENGGUNACollection coll = new KELOMPOKPENGGUNACollection();
            Query qry = new Query(KELOMPOKPENGGUNA.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private KELOMPOKPENGGUNACollection GetPagedItems(KELOMPOKPENGGUNACollection all, int startRowIndex, int maximumRows)
        {
            KELOMPOKPENGGUNACollection items = new KELOMPOKPENGGUNACollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = KELOMPOKPENGGUNA.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, KELOMPOKPENGGUNA.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = KELOMPOKPENGGUNA.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("KELOMPOKPENGGUNA", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new KELOMPOKPENGGUNACollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in KELOMPOKPENGGUNA.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(KELOMPOKPENGGUNA.Schema.TableName,
                ...
                {
                    qry.AddWhere(KELOMPOKPENGGUNA.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(KELOMPOKPENGGUNA.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = KELOMPOKPENGGUNA.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(KELOMPOKPENGGUNA.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = KELOMPOKPENGGUNA.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByQuery(Query qry)
        {
            KELOMPOKPENGGUNACollection coll = new KELOMPOKPENGGUNACollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return KELOMPOKPENGGUNA.FetchAll();
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            KELOMPOKPENGGUNACollection coll = new KELOMPOKPENGGUNACollection();
            Query qry = new Query(KELOMPOKPENGGUNA.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public KELOMPOKPENGGUNACollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        KELOMPOKPENGGUNACollection items = new KELOMPOKPENGGUNACollection();
	        Query qry = new Query( KELOMPOKPENGGUNA.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNA FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new KELOMPOKPENGGUNA();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEKELOMPOK)
        {
            return KELOMPOKPENGGUNA.FetchByParameter("KODEKELOMPOK", KODEKELOMPOK);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public KELOMPOKPENGGUNACollection FetchByID(object KODEKELOMPOK)
        {
            KELOMPOKPENGGUNACollection coll = new KELOMPOKPENGGUNACollection().Where("KODEKELOMPOK", KODEKELOMPOK).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEKELOMPOK)
        {
            return (KELOMPOKPENGGUNA.Delete(KODEKELOMPOK) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEKELOMPOK)
        {
            return (KELOMPOKPENGGUNA.Destroy(KODEKELOMPOK) == 1);
        }
