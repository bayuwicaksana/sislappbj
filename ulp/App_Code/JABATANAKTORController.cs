...
{
    /// <summary>
    /// Controller class for JABATANAKTOR
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class JABATANAKTORController
    {
        // Preload our schema..
        JABATANAKTOR thisSchemaLoad = new JABATANAKTOR();
        ...
        public JABATANAKTORCollection FetchAll()
        {
            JABATANAKTORCollection coll = new JABATANAKTORCollection();
            Query qry = new Query(JABATANAKTOR.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private JABATANAKTORCollection GetPagedItems(JABATANAKTORCollection all, int startRowIndex, int maximumRows)
        {
            JABATANAKTORCollection items = new JABATANAKTORCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = JABATANAKTOR.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, JABATANAKTOR.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = JABATANAKTOR.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("JABATANAKTOR", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new JABATANAKTORCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in JABATANAKTOR.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(JABATANAKTOR.Schema.TableName,
                ...
                {
                    qry.AddWhere(JABATANAKTOR.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(JABATANAKTOR.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = JABATANAKTOR.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(JABATANAKTOR.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = JABATANAKTOR.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByQuery(Query qry)
        {
            JABATANAKTORCollection coll = new JABATANAKTORCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            JABATANAKTORCollection coll = new JABATANAKTORCollection();
            Query qry = new Query(JABATANAKTOR.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public JABATANAKTORCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        JABATANAKTORCollection items = new JABATANAKTORCollection();
	        Query qry = new Query( JABATANAKTOR.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTOR FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new JABATANAKTOR();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEJABATAN)
        {
            return JABATANAKTOR.FetchByParameter("KODEJABATAN", KODEJABATAN);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public JABATANAKTORCollection FetchByID(object KODEJABATAN)
        {
            JABATANAKTORCollection coll = new JABATANAKTORCollection().Where("KODEJABATAN", KODEJABATAN).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEJABATAN)
        {
            return (JABATANAKTOR.Delete(KODEJABATAN) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEJABATAN)
        {
            return (JABATANAKTOR.Destroy(KODEJABATAN) == 1);
        }
