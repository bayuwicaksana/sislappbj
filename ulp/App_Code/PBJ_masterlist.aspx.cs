...
public class PBJMasterList
{
    public static string CreateMasterTableInfo(string detailtable, string[] keys, System.Web.UI.Page page)
    {
                ...
                if(System.Web.HttpContext.Current.Session["locale_xml"] != null)
        {
            ...
            if(!string.IsNullOrEmpty(strTableName))
            {
                smarty.Add("Labels", AspNetRunnerPage.GetFieldCaptions((XmlNode)System.Web.HttpContext.Current.Session["locale_xml"], 
                    (string)System.Web.HttpContext.Current.Session["language"], "dbo_PBJ"));
            }
        }
        ...
        PBJ item = controller.FetchByManyID(par);

	    string keylink = string.Empty;
        if(item != null)
        {
	    keylink += "&key1=" + Control.HTMLEncodeSpecialChars(HttpUtility.UrlEncode(item.KODEPBJ.ToString()));
        }
        	
        string value="";

        Control control_KODEPBJ = new Control("KODEPBJ", item.KODEPBJ, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	KODEPBJ - 
        ...
        Control control_NAMAKEGIATAN = new Control("NAMAKEGIATAN", item.NAMAKEGIATAN, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	NAMAKEGIATAN - 
        ...
        Control control_NAMAPAKET = new Control("NAMAPAKET", item.NAMAPAKET, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	NAMAPAKET - 
        ...
        Control control_PPK = new Control("PPK", item.PPK, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	PPK - 
        ...
        Control control_PPTK = new Control("PPTK", item.PPTK, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	PPTK - 
        ...
        Control control_TANGGALPENGAJUAN = new Control("TANGGALPENGAJUAN", item.TANGGALPENGAJUAN, false, smarty, page.Request, builder, MODE.MODE_LIST);
        ...
        Control control_LENGKAP = new Control("LENGKAP", item.LENGKAP, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	LENGKAP - 
        ...
        Control control_DIKEMBALIKAN = new Control("DIKEMBALIKAN", item.DIKEMBALIKAN, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	DIKEMBALIKAN - 
        ...
        Control control_KODESTATUSPBJ = new Control("KODESTATUSPBJ", item.KODESTATUSPBJ, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	KODESTATUSPBJ - 
            ...
            return func.BuildOutput(page, @"~\PBJ_masterlist.aspx", smarty);
    }
}
