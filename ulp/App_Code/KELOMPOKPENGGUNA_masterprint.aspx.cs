...
public class KELOMPOKPENGGUNAMasterPrint
{
    public static string DisplayMasterTableInfo(string sourcetable, IList<object> masterkeys, System.Web.UI.Page page)
    {
        ...
        smarty.Add("__table", "KELOMPOKPENGGUNA");
        ...
        KELOMPOKPENGGUNACollection collection = controller.FetchByID(masterkeys[0]);

	    string keylink = string.Empty;
        if(collection != null && collection.Count > 0)
        {
	    keylink += "&key1=" + Control.HTMLEncodeSpecialChars(HttpUtility.UrlEncode(collection[0].KODEKELOMPOK.ToString()));
        }
        	
        string value="";

        Control control_KODEKELOMPOK = new Control("KODEKELOMPOK", collection[0].KODEKELOMPOK, false, smarty, page.Request, builder, MODE.MODE_LIST);
        //	KODEKELOMPOK - 
        ...
        //	DESKRIPSI - 
            ...
            return func.BuildOutput(page, @"~\KELOMPOKPENGGUNA_masterprint.aspx", smarty);
    }
}
