...
{
    /// <summary>
    /// Controller class for TIPEAKTOR
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class TIPEAKTORController
    {
        // Preload our schema..
        TIPEAKTOR thisSchemaLoad = new TIPEAKTOR();
        ...
        public TIPEAKTORCollection FetchAll()
        {
            TIPEAKTORCollection coll = new TIPEAKTORCollection();
            Query qry = new Query(TIPEAKTOR.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private TIPEAKTORCollection GetPagedItems(TIPEAKTORCollection all, int startRowIndex, int maximumRows)
        {
            TIPEAKTORCollection items = new TIPEAKTORCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = TIPEAKTOR.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, TIPEAKTOR.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = TIPEAKTOR.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("TIPEAKTOR", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new TIPEAKTORCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in TIPEAKTOR.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(TIPEAKTOR.Schema.TableName,
                ...
                {
                    qry.AddWhere(TIPEAKTOR.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(TIPEAKTOR.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = TIPEAKTOR.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(TIPEAKTOR.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = TIPEAKTOR.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByQuery(Query qry)
        {
            TIPEAKTORCollection coll = new TIPEAKTORCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            TIPEAKTORCollection coll = new TIPEAKTORCollection();
            Query qry = new Query(TIPEAKTOR.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public TIPEAKTORCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        TIPEAKTORCollection items = new TIPEAKTORCollection();
	        Query qry = new Query( TIPEAKTOR.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTOR FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new TIPEAKTOR();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODETIPE)
        {
            return TIPEAKTOR.FetchByParameter("KODETIPE", KODETIPE);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public TIPEAKTORCollection FetchByID(object KODETIPE)
        {
            TIPEAKTORCollection coll = new TIPEAKTORCollection().Where("KODETIPE", KODETIPE).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODETIPE)
        {
            return (TIPEAKTOR.Delete(KODETIPE) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODETIPE)
        {
            return (TIPEAKTOR.Destroy(KODETIPE) == 1);
        }
