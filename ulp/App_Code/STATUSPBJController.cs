...
{
    /// <summary>
    /// Controller class for STATUSPBJ
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class STATUSPBJController
    {
        // Preload our schema..
        STATUSPBJ thisSchemaLoad = new STATUSPBJ();
        ...
        public STATUSPBJCollection FetchAll()
        {
            STATUSPBJCollection coll = new STATUSPBJCollection();
            Query qry = new Query(STATUSPBJ.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private STATUSPBJCollection GetPagedItems(STATUSPBJCollection all, int startRowIndex, int maximumRows)
        {
            STATUSPBJCollection items = new STATUSPBJCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = STATUSPBJ.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, STATUSPBJ.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = STATUSPBJ.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("STATUSPBJ", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new STATUSPBJCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in STATUSPBJ.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(STATUSPBJ.Schema.TableName,
                ...
                {
                    qry.AddWhere(STATUSPBJ.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(STATUSPBJ.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = STATUSPBJ.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(STATUSPBJ.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = STATUSPBJ.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByQuery(Query qry)
        {
            STATUSPBJCollection coll = new STATUSPBJCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            STATUSPBJCollection coll = new STATUSPBJCollection();
            Query qry = new Query(STATUSPBJ.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public STATUSPBJCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        STATUSPBJCollection items = new STATUSPBJCollection();
	        Query qry = new Query( STATUSPBJ.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJ FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new STATUSPBJ();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODESTATUS)
        {
            return STATUSPBJ.FetchByParameter("KODESTATUS", KODESTATUS);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public STATUSPBJCollection FetchByID(object KODESTATUS)
        {
            STATUSPBJCollection coll = new STATUSPBJCollection().Where("KODESTATUS", KODESTATUS).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODESTATUS)
        {
            return (STATUSPBJ.Delete(KODESTATUS) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODESTATUS)
        {
            return (STATUSPBJ.Destroy(KODESTATUS) == 1);
        }
