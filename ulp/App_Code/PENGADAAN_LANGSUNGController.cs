...
{
    /// <summary>
    /// Controller class for PENGADAAN_LANGSUNG
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class PENGADAAN_LANGSUNGController
    {
        // Preload our schema..
        PENGADAAN_LANGSUNG thisSchemaLoad = new PENGADAAN_LANGSUNG();
        ...
        public PENGADAAN_LANGSUNGCollection FetchAll()
        {
            PENGADAAN_LANGSUNGCollection coll = new PENGADAAN_LANGSUNGCollection();
            Query qry = new Query(PENGADAAN_LANGSUNG.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }

        
        private PENGADAAN_LANGSUNGCollection GetPagedItems(PENGADAAN_LANGSUNGCollection all, int startRowIndex, int maximumRows)
        {
            PENGADAAN_LANGSUNGCollection items = new PENGADAAN_LANGSUNGCollection();
        ...
        private string GetValue(string sSearchOperation, Comparison cmprzn, object value, string column)
        {
            ...
            if (value != null)
            {
                ...
                TableSchema.TableColumn col = PENGADAAN_LANGSUNG.Schema.GetColumn(column);
        ...
        private void AddWhere(Query qry, DataProvider provider, string column, string cmprzn, string searchfor,  string searchfor2, bool isAdd, bool not)
        {
            ...
            string properTableName = SubSonic.TableSchema.AbstractTableSchema.TransformClassName(qry.Schema.Name, false, PENGADAAN_LANGSUNG.Schema.TableType,provider);
            string columnName = builder.SubSonicTables[properTableName].Fields[column].Name;
            TableSchema.TableColumn col = PENGADAAN_LANGSUNG.Schema.GetColumn(columnName);
        ...
        public List<string> FetchForSearchSuggest(string column, object value, bool startsWith, string ownerCol, string userId)
        {
            ...
            {
                qry.OrderBy = OrderBy.Asc(Utility.QualifyColumnName("PENGADAAN_LANGSUNG", column, qry.Provider));
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
            {
                ...
                else
                {
                    ...
                    if (sValue == null)
                    {
                        return new PENGADAAN_LANGSUNGCollection();
                    }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByParameter(string column, string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            string sValue;
            Comparison cmprzn;
            if (value != null)
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            foreach (TableSchema.TableColumn col in PENGADAAN_LANGSUNG.Schema.Columns)
            {
                ...
                if (cmprzn == Comparison.Like || cmprzn == Comparison.NotLike)
                {
                    qry.AddWhereIgnoreColumnType(PENGADAAN_LANGSUNG.Schema.TableName,
                ...
                {
                    qry.AddWhere(PENGADAAN_LANGSUNG.Schema.TableName,
                        Utility.BuildParameterNameIgnorePrefix(col.ParameterName),
                        col.ColumnName,
                        cmprzn,
                        sValue, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByAllParameters(string sSearchOperation, object value, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId, IDictionary<string, object> par)
        {
            Comparison cmprzn = (value == null) ? Comparison.Is : GetComparison(sSearchOperation);
            Query qry = new Query(PENGADAAN_LANGSUNG.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        public IDataReader FetchReaderByAllParameters(List<string> fields, string sSearchOperation, object value,  int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
            ...
            {
                TableSchema.TableColumn col = PENGADAAN_LANGSUNG.Schema.GetColumn(field);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByParameter(string condition, string sSearchOperation, object value, int startRowIndex, int maximumRows, string ownerCol, string userId)
        {
            Comparison cmprzn = GetComparison(sSearchOperation);
            Query qry = new Query(PENGADAAN_LANGSUNG.Schema);
            qry.Top = GetTop(startRowIndex, maximumRows);
            TableSchema.Table schema = PENGADAAN_LANGSUNG.Schema;
            string sValue;
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchForAdvancedSearch(string[] fields, 
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchForDetails(
            IDictionary<string, object> par,
            string sortColumnsBy, 
            string ownerCol, 
            string userId)
       ...
       [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchSelected(
            string[] columns,
            string[] selection,
            string sortColumnsBy, 
            string ownerCol, 
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchReaderByQuery(string sql, string parms, int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
...
, StringSplitOptions.RemoveEmptyEntries);
		...
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByQuery(Query qry)
        {
            PENGADAAN_LANGSUNGCollection coll = new PENGADAAN_LANGSUNGCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return PENGADAAN_LANGSUNG.FetchAll();
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchAll(string sortColumnsBy, string ownerCol, string userId)
        {
            PENGADAAN_LANGSUNGCollection coll = new PENGADAAN_LANGSUNGCollection();
            Query qry = new Query(PENGADAAN_LANGSUNG.Schema);
...
, StringSplitOptions.RemoveEmptyEntries);
        ...
        [DataObjectMethod( DataObjectMethodType.Select, false )]
        public PENGADAAN_LANGSUNGCollection FetchAllPaged(int startRowIndex, int maximumRows, string sortColumnsBy, string ownerCol, string userId)
        {
	        PENGADAAN_LANGSUNGCollection items = new PENGADAAN_LANGSUNGCollection();
	        Query qry = new Query( PENGADAAN_LANGSUNG.Schema );
	        qry.Top = GetTop(startRowIndex, maximumRows);
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNG FetchByManyID(IDictionary<string, object> par)
        {
            if (par == null)
            {
                return new PENGADAAN_LANGSUNG();
            }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public IDataReader FetchReaderByID(object KODEPENGADAANLANGSUNG)
        {
            return PENGADAAN_LANGSUNG.FetchByParameter("KODEPENGADAANLANGSUNG", KODEPENGADAANLANGSUNG);
        }

        
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PENGADAAN_LANGSUNGCollection FetchByID(object KODEPENGADAANLANGSUNG)
        {
            PENGADAAN_LANGSUNGCollection coll = new PENGADAAN_LANGSUNGCollection().Where("KODEPENGADAANLANGSUNG", KODEPENGADAANLANGSUNG).Load();
            return coll;
        }

        
        [DataObjectMethod(DataObjectMethodType.Delete, true)]
        public bool Delete(object KODEPENGADAANLANGSUNG)
        {
            return (PENGADAAN_LANGSUNG.Delete(KODEPENGADAANLANGSUNG) == 1);
        }

        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object KODEPENGADAANLANGSUNG)
        {
            return (PENGADAAN_LANGSUNG.Destroy(KODEPENGADAANLANGSUNG) == 1);
        }
