<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="STATUSPBJ_Edit.aspx.cs" Inherits="CSTATUSPBJ_Edit" %>-->
<html>
<head><title>STATUS PBJ</title>
...
STATUS PBJ, Edit record [
KODE STATUS: {$show_key1}
]
</div>
...
<tr>
    <td class=editshadeleft_b width=150 style="padding-left:15px;">KODE STATUS</td>
    <td width=250 class=editshaderight_lb style="padding-left:10px;">
    {$KODESTATUS_editcontrol}
...
<tr>
    <td class=editshade_b width=150 style="padding-left:15px;">URUTAN</td>
    <td width=250 class=editshade_lb style="padding-left:10px;">
    {$URUTAN_editcontrol}
      &nbsp;<img src="images/icon_required.gif">
  </td></tr>
