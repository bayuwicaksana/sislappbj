<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="PENGGUNA_List.aspx.cs" Inherits="CPENGGUNA_List" %>-->
<html>
<head>
...
<option value="KODEPENGGUNA" {$KODEPENGGUNA_searchfieldoption}>KODE PENGGUNA</option>
<option value="NAMA" {$NAMA_searchfieldoption}>NAMA PENGGUNA</option>
<option value="KATAKUNCI" {$KATAKUNCI_searchfieldoption}>KATA KUNCI</option>
<option value="KODEKELOMPOK" {$KODEKELOMPOK_searchfieldoption}>KELOMPOK PENGGUNA</option>
</select>
...
{BEGIN KODEPENGGUNA_fieldheadercolumn}
<td class="headerlist">
{BEGIN KODEPENGGUNA_fieldheader}
<a class="tablelinks" {$KODEPENGGUNA_orderlinkattrs}>
KODE PENGGUNA</a>
{END KODEPENGGUNA_fieldheader}
</td>
{END KODEPENGGUNA_fieldheadercolumn}
...
{BEGIN KATAKUNCI_fieldheadercolumn}
<td class="headerlist">
{BEGIN KATAKUNCI_fieldheader}
<a class="tablelinks" {$KATAKUNCI_orderlinkattrs}>
KATA KUNCI</a>
{END KATAKUNCI_fieldheader}
</td>
{END KATAKUNCI_fieldheadercolumn}
{BEGIN KODEKELOMPOK_fieldheadercolumn}
<td class="headerlist_right2">
{BEGIN KODEKELOMPOK_fieldheader}
<a class="tablelinks" {$KODEKELOMPOK_orderlinkattrs}>
KELOMPOK PENGGUNA</a>
{END KODEKELOMPOK_fieldheader}
</td>
{END KODEKELOMPOK_fieldheadercolumn}
...
{BEGIN KODEPENGGUNA_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODEPENGGUNA_style}>
{$KODEPENGGUNA_value}
</td>
{END KODEPENGGUNA_fieldcolumn}
{BEGIN NAMA_fieldcolumn}
<td align=center valign=middle class=borderbody {$NAMA_style}>
{$NAMA_value}
</td>
{END NAMA_fieldcolumn}
{BEGIN KATAKUNCI_fieldcolumn}
<td align=center valign=middle class=borderbody {$KATAKUNCI_style}>
{$KATAKUNCI_value}
</td>
{END KATAKUNCI_fieldcolumn}
{BEGIN KODEKELOMPOK_fieldcolumn}
<td align=center valign=middle  {$KODEKELOMPOK_style}>
{$KODEKELOMPOK_value}
</td>
{END KODEKELOMPOK_fieldcolumn}
<td>&nbsp;</td>
