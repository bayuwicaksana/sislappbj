<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELENGKAPANPBJ_Search.aspx.cs" Inherits="CKELENGKAPANPBJ_Search" %>-->
<html>
<head>
<title>KELENGKAPAN PBJ: Advanced search page</title>
...
KELENGKAPAN PBJ - Advanced search</div>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">KODE BPJ</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEBPJ_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEBPJ}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEBPJ_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEBPJ">
	{$KODEBPJ_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KODEBPJ_fieldblock}	
{BEGIN KODEKELENGKAPAN_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">KODE KELENGKAPAN</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEKELENGKAPAN_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEKELENGKAPAN}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEKELENGKAPAN_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEKELENGKAPAN">
	{$KODEKELENGKAPAN_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KODEKELENGKAPAN_fieldblock}	
{BEGIN TANGGALDITERIMA_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">TANGGAL DITERIMA</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$TANGGALDITERIMA_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_TANGGALDITERIMA}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$TANGGALDITERIMA_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_TANGGALDITERIMA">
	{$TANGGALDITERIMA_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END TANGGALDITERIMA_fieldblock}	
{BEGIN PENERIMAKELENGKAPAN_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">PENERIMA KELENGKAPAN</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$PENERIMAKELENGKAPAN_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_PENERIMAKELENGKAPAN}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$PENERIMAKELENGKAPAN_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_PENERIMAKELENGKAPAN">
	{$PENERIMAKELENGKAPAN_editcontrol1}
	</span>&nbsp;</td>
</tr>
