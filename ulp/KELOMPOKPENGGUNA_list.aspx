<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELOMPOKPENGGUNA_List.aspx.cs" Inherits="CKELOMPOKPENGGUNA_List" %>-->
<html>
<head>
<title>KELOMPOK PENGGUNA</title>
...
<option value="KODEKELOMPOK" {$KODEKELOMPOK_searchfieldoption}>KODE KELOMPOK</option>
...
{BEGIN PENGGUNA_dtable_column}
<td width=50 class="headerlist">&nbsp;</td>
{END PENGGUNA_dtable_column}
...
{BEGIN PENGGUNA_dtable_column}
<td align="center" valign=middle class=borderbody>
{BEGIN PENGGUNA_dtable_link}
<a  {$PENGGUNA_dtablelink_attrs}>PENGGUNA{BEGIN PENGGUNA_childcount}({$PENGGUNA_childnumber})
{END PENGGUNA_childcount}
</a>
{END PENGGUNA_dtable_link}
</td>
{END PENGGUNA_dtable_column}

{BEGIN KODEKELOMPOK_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODEKELOMPOK_style}>
{$KODEKELOMPOK_value}
</td>
{END KODEKELOMPOK_fieldcolumn}
{BEGIN DESKRIPSI_fieldcolumn}
<td align=center valign=middle  {$DESKRIPSI_style}>
{$DESKRIPSI_value}
</td>
