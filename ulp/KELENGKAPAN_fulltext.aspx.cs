...
public partial class CKELENGKAPAN_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\KELENGKAPAN_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
    ...
    {
        keys["KODEKELENGKAPAN"] = Request["key1"];
