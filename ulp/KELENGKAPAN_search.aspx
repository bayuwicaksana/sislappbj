<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELENGKAPAN_Search.aspx.cs" Inherits="CKELENGKAPAN_Search" %>-->
<html>
<head>
<title>KELENGKAPAN: Advanced search page</title>
...
KELENGKAPAN - Advanced search</div>
...
{BEGIN KODEDOKUMEN_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">DOKUMEN</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEDOKUMEN_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEDOKUMEN}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEDOKUMEN_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEDOKUMEN">
	{$KODEDOKUMEN_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KODEDOKUMEN_fieldblock}	
{BEGIN KODEJENISKEGIATAN_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">JENIS KEGIATAN</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEJENISKEGIATAN_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEJENISKEGIATAN}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEJENISKEGIATAN_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEJENISKEGIATAN">
	{$KODEJENISKEGIATAN_editcontrol1}
	</span>&nbsp;</td>
</tr>
