...
public partial class CPENGADAAN_LANGSUNG_Addnewitem : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.Response.Write(func.BuildOutput(this, @"~\PENGADAAN_LANGSUNG_addnewitem.aspx", smarty));
        this.Response.End();
    }
