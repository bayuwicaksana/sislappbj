<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="STATUSPBJ_Search.aspx.cs" Inherits="CSTATUSPBJ_Search" %>-->
<html>
<head>
<title>STATUS PBJ: Advanced search page</title>
...
STATUS PBJ - Advanced search</div>
...
{BEGIN KODESTATUS_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">KODE STATUS</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODESTATUS_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODESTATUS}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODESTATUS_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODESTATUS">
	{$KODESTATUS_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KODESTATUS_fieldblock}	
...
{BEGIN URUTAN_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">URUTAN</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$URUTAN_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_URUTAN}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$URUTAN_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_URUTAN">
	{$URUTAN_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END URUTAN_fieldblock}	
</table>
