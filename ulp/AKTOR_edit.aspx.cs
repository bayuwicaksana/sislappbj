...
public partial class CAKTOR_Edit : AspNetRunnerPage 
{
    ...
    private void SaveData()
    {
        ...
        Data.AKTOR emptyItem = new Data.AKTOR();
        ...
        {
            item.KODEJABATAN = emptyItem.KODEJABATAN;
        }
        ...
        {
            item.KODETIPE = emptyItem.KODETIPE;
        }
        //
    ...
    private void BuildForm()
    {
        ...
        else
        {
            ...
            {
                control_KODETIPE = new Control("KODETIPE", defvalues["KODETIPE"], false, smarty, this.Request, builder, ctrlMode);
            }
            else
            {
                control_KODETIPE = new Control("KODETIPE", item.KODETIPE, false, smarty, this.Request, builder, ctrlMode);
            }
    ...
    private void BuildBody()
    {
		...
		body["begin"] = includes + 
		"<form name=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"AKTOR_edit.aspx\" " + onsubmit + ">" +
    ...
    private bool Init()
    {
        ...
        if(inlineedit)
        {
	        templatefile = "AKTOR_inline_edit.aspx";
        }
        else
        {
	        templatefile = "AKTOR_edit.aspx";
        }
        ...
        if(item != null)
        {
            ...
            if(!editable)
            {
                output.Append("<p>" + "You don't have permissions to access this table" + " <a href=\"AKTOR_list.aspx?a=return\">back</a>");
                return false;
            }
        }
        else
        {
            this.Server.Transfer("~/AKTOR_list.aspx?a=return");
        }
