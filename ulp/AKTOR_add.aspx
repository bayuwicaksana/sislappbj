<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="AKTOR_Add.aspx.cs" Inherits="CAKTOR_Add" %>-->
<html>
<head><title>AKTOR</title>
...
<tr>
    <td class=editshadeleft_b width=150 style="padding-left:15px;">NIP</td>
...
<tr>
    <td class=editshade_b width=150 style="padding-left:15px;">JABATAN</td>
    <td width=250 class=editshade_lb style="padding-left:10px;">
...
<tr>
    <td class=editshade_b width=150 style="padding-left:15px;">TIPE</td>
    <td width=250 class=editshade_lb style="padding-left:10px;">
    {$KODETIPE_editcontrol}
    </td></tr>
