<%@ Page Language="VB" AutoEventWireup="true" CodeFile="surat_hasil_lelang.aspx.vb" Inherits="surat_hasil_lelang" MasterPageFile="~/Default.master" Title="Surat Hasil Pelelangan"%>
<asp:Content ID="Content1" Runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
<script language="javascript">
function showDialog(){
	vReturnValue = window.showModalDialog("WebForm1.aspx","#1","dialogHeight: 300px; dialogWidth: 600px;" + "dialogTop: 190px;  dialogLeft: 220px; edge: Raised; center: Yes;" + "help: No; resizable: No; status: No;");
	__doPostBack("btnRetrieve','');
    ...
    SelectCommand="with monthlist as (select 1 as bulan union all select yl.bulan + 1 as bulan from monthlist yl where yl.bulan + 1 <= MONTH('2020-12-31')) select bulan from monthlist order by bulan asc;">
        ...
        <!-- <tr>
            <td width="40%" align="right">SKPD Pemohon: </td>
            <td align='left'>
    ...
    SelectCommand="SELECT DISTINCT KODEJENISKEGIATAN as [KD_STATUS], DESKRIPSI as [DESC_STATUS] FROM [JENISKEGIATAN]">
        ...
        <tr>
            <td colspan=2 align="center" >
                ...
                <asp:Button ID="btnUpdate" runat="server" Text="Clear" visible="false" />
