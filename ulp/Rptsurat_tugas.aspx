<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Rptsurat_tugas.aspx.vb" Inherits="Rptsurat_tugas" MasterPageFile="~/Default.master" Title="Daftar Surat Tugas"%>
    ...
    SelectCommand="with yearlist as (select 2010 as year union all select yl.year + 1 as year from yearlist yl where yl.year + 1 <= YEAR('2020-12-31')) select year as THN_ANGGARAN from yearlist order by year desc;">
        ...
        <tr>
            <td colspan=2 align="center" >
                ...
                <input type="button" value="Cetak" onclick="javascript:printDiv('ctl00_ContentPlaceHolder1_Msg')" /></td>
        </tr>
    </table>      
	</center>
    <br />
