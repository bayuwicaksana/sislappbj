...
public partial class CPENGGUNA_Edit : AspNetRunnerPage 
{
    ...
    private void BuildForm()
    {
        ...
        else
        {
            ...
            {
                control_KODEPENGGUNA = new Control("KODEPENGGUNA", defvalues["KODEPENGGUNA"], false, smarty, this.Request, builder, ctrlMode);
            }
            else
            {
                control_KODEPENGGUNA = new Control("KODEPENGGUNA", item.KODEPENGGUNA, false, smarty, this.Request, builder, ctrlMode);
            }
            ...
            {
                control_KATAKUNCI = new Control("KATAKUNCI", defvalues["KATAKUNCI"], false, smarty, this.Request, builder, ctrlMode);
            }
            else
            {
                control_KATAKUNCI = new Control("KATAKUNCI", item.KATAKUNCI, false, smarty, this.Request, builder, ctrlMode);
            }
    ...
    private void BuildBody()
    {
		...
		body["begin"] = includes + 
		"<form name=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"PENGGUNA_edit.aspx\" " + onsubmit + ">" +
        ...
        body["begin"] +="<input type=\"hidden\" name=\"editid1\" value=\""+ Control.HTMLEncodeSpecialChars(keys["KODEPENGGUNA"].ToString()) + "\">";
	    	    smarty.Add("show_key1", Control.HTMLEncodeSpecialChars(control_KODEPENGGUNA.GetData()));
        ...
        showKeys.Add(Server.UrlEncode(keys["KODEPENGGUNA"].ToString()));
    }
