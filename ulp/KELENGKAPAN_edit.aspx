<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELENGKAPAN_Edit.aspx.cs" Inherits="CKELENGKAPAN_Edit" %>-->
<html>
<head><title>KELENGKAPAN</title>
...
KELENGKAPAN, Edit record [
KODE KELENGKAPAN: {$show_key1}
]
</div>
...
<tr>
    <td class=editshadeleft_b width=150 style="padding-left:15px;">KODE KELENGKAPAN</td>
...
<tr>
    <td class=editshade_b width=150 style="padding-left:15px;">DOKUMEN</td>
    <td width=250 class=editshade_lb style="padding-left:10px;">
    {$KODEDOKUMEN_editcontrol}
      &nbsp;<img src="images/icon_required.gif">
  </td></tr>
