<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELENGKAPANPBJ_List.aspx.cs" Inherits="CKELENGKAPANPBJ_List" %>-->
<html>
<head>
<title>KELENGKAPAN PBJ</title>
...
<option value="KODEBPJ" {$KODEBPJ_searchfieldoption}>KODE BPJ</option>
<option value="KODEKELENGKAPAN" {$KODEKELENGKAPAN_searchfieldoption}>KODE KELENGKAPAN</option>
<option value="TANGGALDITERIMA" {$TANGGALDITERIMA_searchfieldoption}>TANGGAL DITERIMA</option>
<option value="PENERIMAKELENGKAPAN" {$PENERIMAKELENGKAPAN_searchfieldoption}>PENERIMA KELENGKAPAN</option>
</select>
...
{BEGIN KODEBPJ_fieldheadercolumn}
<td class="headerlist">
{BEGIN KODEBPJ_fieldheader}
<a class="tablelinks" {$KODEBPJ_orderlinkattrs}>
KODE BPJ</a>
{END KODEBPJ_fieldheader}
</td>
{END KODEBPJ_fieldheadercolumn}
{BEGIN KODEKELENGKAPAN_fieldheadercolumn}
<td class="headerlist">
{BEGIN KODEKELENGKAPAN_fieldheader}
<a class="tablelinks" {$KODEKELENGKAPAN_orderlinkattrs}>
KODE KELENGKAPAN</a>
{END KODEKELENGKAPAN_fieldheader}
</td>
{END KODEKELENGKAPAN_fieldheadercolumn}
{BEGIN TANGGALDITERIMA_fieldheadercolumn}
<td class="headerlist">
{BEGIN TANGGALDITERIMA_fieldheader}
<a class="tablelinks" {$TANGGALDITERIMA_orderlinkattrs}>
TANGGAL DITERIMA</a>
{END TANGGALDITERIMA_fieldheader}
</td>
{END TANGGALDITERIMA_fieldheadercolumn}
{BEGIN PENERIMAKELENGKAPAN_fieldheadercolumn}
<td class="headerlist_right2">
{BEGIN PENERIMAKELENGKAPAN_fieldheader}
<a class="tablelinks" {$PENERIMAKELENGKAPAN_orderlinkattrs}>
PENERIMA KELENGKAPAN</a>
{END PENERIMAKELENGKAPAN_fieldheader}
</td>
{END PENERIMAKELENGKAPAN_fieldheadercolumn}
...
{BEGIN KODEBPJ_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODEBPJ_style}>
{$KODEBPJ_value}
</td>
{END KODEBPJ_fieldcolumn}
{BEGIN KODEKELENGKAPAN_fieldcolumn}
<td align=center valign=middle class=borderbody {$KODEKELENGKAPAN_style}>
{$KODEKELENGKAPAN_value}
</td>
{END KODEKELENGKAPAN_fieldcolumn}
{BEGIN TANGGALDITERIMA_fieldcolumn}
<td align=center valign=middle class=borderbody {$TANGGALDITERIMA_style}>
{$TANGGALDITERIMA_value}
</td>
{END TANGGALDITERIMA_fieldcolumn}
{BEGIN PENERIMAKELENGKAPAN_fieldcolumn}
<td align=center valign=middle  {$PENERIMAKELENGKAPAN_style}>
{$PENERIMAKELENGKAPAN_value}
</td>
{END PENERIMAKELENGKAPAN_fieldcolumn}
<td>&nbsp;</td>
