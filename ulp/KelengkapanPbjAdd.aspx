...
<html>
  <head>
    ...
    function OnSubmit()
    {
		var textOleh = document.Main.txtOleh.value;
        ...
        document.Main.action = "KelengkapanPbjAdd.aspx";
        return true;        
    }
    </script>
	<STYLE>
  ...
  <body MS_POSITIONING="GridLayout">
    ...
    <input type="submit" value="Cancel" onclick="location.href='KELENGKAPANPBJ_list.aspx?<%=Request["hid_selected_pbj"]%>&mastertable=PBJ';">
	<%
    if (Request["hid_selected_lang"] != null && Request["hid_selected_lang"] != "")
    {
	%>
    <input type="submit" value="Submit" onclick="location.href='tambah_kelengkapanpbj.aspx?<%=Request["hid_selected_pbj"]%>&lkppbj=<%=Request["hid_selected_lang"]%>&oleh=<%=Request["hid_selected_oleh"]%>';">
    <%
	}
	%>
  </body>
