<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="DOKUMEN_List.aspx.cs" Inherits="CDOKUMEN_List" %>-->
<html>
<head>
<title>DOKUMEN</title>
...
<option value="KODEDOKUMEN" {$KODEDOKUMEN_searchfieldoption}>KODE DOKUMEN</option>
...
{BEGIN KELENGKAPAN_dtable_column}
<td width=50 class="headerlist">&nbsp;</td>
{END KELENGKAPAN_dtable_column}
...
{BEGIN KELENGKAPAN_dtable_column}
<td align="center" valign=middle class=borderbody>
{BEGIN KELENGKAPAN_dtable_link}
<a  {$KELENGKAPAN_dtablelink_attrs}>KELENGKAPAN{BEGIN KELENGKAPAN_childcount}({$KELENGKAPAN_childnumber})
{END KELENGKAPAN_childcount}
</a>
{END KELENGKAPAN_dtable_link}
</td>
{END KELENGKAPAN_dtable_column}
