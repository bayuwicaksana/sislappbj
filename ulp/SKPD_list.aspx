<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="SKPD_List.aspx.cs" Inherits="CSKPD_List" %>-->
<html>
<head>
<title>SKPD</title>
...
<option value="KODESKPD" {$KODESKPD_searchfieldoption}>KODE SKPD</option>
...
<td align=center valign=middle  {$ALAMAT_style}>
{$ALAMAT_value}
</td>
