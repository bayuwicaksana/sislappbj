<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="KELOMPOKPENGGUNA_Edit.aspx.cs" Inherits="CKELOMPOKPENGGUNA_Edit" %>-->
<html>
<head><title>KELOMPOK PENGGUNA</title>
...
KELOMPOK PENGGUNA, Edit record [
KODE KELOMPOK: {$show_key1}
]
</div>
...
<tr>
    <td class=editshadeleft_b width=150 style="padding-left:15px;">KODE KELOMPOK</td>
