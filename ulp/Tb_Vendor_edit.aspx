<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="Tb_Vendor_Edit.aspx.cs" Inherits="CTb_Vendor_Edit" %>-->
...
{BEGIN body}
<br/><br/><br/>
<TABLE align=center id="center_block" cellpadding=0 cellspacing=0><tr><td>
...
{BEGIN message_block}
<div id="message_block" class=downedit>{$message}</div>
{END message_block}
