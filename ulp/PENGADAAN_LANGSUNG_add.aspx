...
<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="PENGADAAN_LANGSUNG_Add.aspx.cs" Inherits="CPENGADAAN_LANGSUNG_Add" %>--><HTML><HEAD><TITLE>PENGADAAN LANGSUNG</TITLE>
  ...
  <TR>
    <TD id=contents_block>{BEGIN flybody}<B class=xtop><B 
      ...
      <TABLE id="fields_block{$id}" cellSpacing=0 cellPadding=4 border=0>
        <TBODY>
        {BEGIN NAMAKEGIATAN_fieldblock}<TR>
          <TD class=editshadeleft_b style="PADDING-LEFT: 15px" width=150>NAMA 
            KEGIATAN</TD>
        ...
        {BEGIN NAMAPAKET_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>NAMA 
          PAKET</TD>
        ...
        {BEGIN KODESKPD_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>SKPD</TD>
        ...
        {BEGIN TANGGALKONTRAK_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>TANGGAL 
            KONTRAK</TD>
        ...
        {BEGIN PAGU_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>PAGU</TD>
          <TD class=editshade_lb style="PADDING-LEFT: 10px" width=250>{$PAGU_editcontrol} </TD></TR>{END PAGU_fieldblock}
        {BEGIN HPS_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>HPS</TD>
          <TD class=editshade_lb style="PADDING-LEFT: 10px" width=250>{$HPS_editcontrol} </TD></TR>{END HPS_fieldblock}
        {BEGIN NILAIKONTRAK_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>NILAI 
            KONTRAK</TD>
          <TD class=editshade_lb style="PADDING-LEFT: 10px" width=250>{$NILAIKONTRAK_editcontrol} </TD></TR>{END NILAIKONTRAK_fieldblock}
        {BEGIN PEMENANG_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" 
          width=150>PEMENANG</TD>
          <TD class=editshade_lb style="PADDING-LEFT: 10px" width=250>{$PEMENANG_editcontrol} &nbsp;<IMG 
            src="images/icon_required.gif"> </TD></TR>{END PEMENANG_fieldblock}
        {BEGIN KETERANGAN_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>JENIS 
            KEGIATAN</TD>
        ...
        {BEGIN PEJABATPENGADAAN_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" width=150>JENIS PENGADAAN</TD>
        ...
        {BEGIN MENGETAHUI_fieldblock}<TR>
          <TD class=editshade_b style="PADDING-LEFT: 15px" 
          width=150>PPK</TD>
          <TD class=editshade_lb style="PADDING-LEFT: 10px" width=250>{$MENGETAHUI_editcontrol} &nbsp;<IMG 
            src="images/icon_required.gif"> </TD></TR>{END MENGETAHUI_fieldblock}</TBODY></TABLE>
      <DIV id="buttons_block{$id}" class=downedit>
      ...
      class=xb1b4></B></B>{END flybody}</TD></TR></TBODY></TABLE>{END body}{$footer} 
</BODY></HTML>
