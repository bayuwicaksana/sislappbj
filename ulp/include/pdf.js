...
{
	CalcMaxPage();
	window.frames['pdf'].location.href=page+'&width='+maxwidth+'&height='+maxheight;
//	display progress div	
	var pdiv=document.getElementById("progress");
	pdiv.innerHTML = "<p>Building PDF<br><span style=\"display:block;background:white;border:solid black 1px;width:100px;height:20px;\"><span id=progress_bar style=\"display:block;background:#6080FF;width:1px;height:100%\"></span></span><br><span id=progress_percent></span>% done</p>";
	CheckProgress();
}
window.pdfbuilt=0;
window.counter=0;
