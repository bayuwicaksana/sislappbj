<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="AKTOR_Search.aspx.cs" Inherits="CAKTOR_Search" %>-->
<html>
<head>
<title>AKTOR: Advanced search page</title>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">NIP</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$NIP_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_NIP}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$NIP_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_NIP">
	{$NIP_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END NIP_fieldblock}	
...
<tr>
	<td class=editshade_b style="padding-left:15px;">NAMA</td>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">JABATAN</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEJABATAN_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEJABATAN}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEJABATAN_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEJABATAN">
	{$KODEJABATAN_editcontrol1}
	</span>&nbsp;</td>
</tr>
{END KODEJABATAN_fieldblock}	
{BEGIN KODETIPE_fieldblock}	
<tr>
	<td class=editshade_b style="padding-left:15px;">TIPE</td>
