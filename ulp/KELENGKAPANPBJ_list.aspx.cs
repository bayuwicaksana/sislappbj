...
public partial class CKELENGKAPANPBJ_List : AspNetRunnerPage 
{
    ...
    Data.KELENGKAPANPBJCollection collection;
    ...
    protected void Page_Load( object sender,  System.EventArgs e)  
    {
        string output = string.Empty;
                        if (User != null && !string.IsNullOrEmpty("KELENGKAPANPBJ"))
            {
                OwnerColumn = func.GetOwnerIDField("KELENGKAPANPBJ");
            }
            rowinfo = array();
            bodyDict = array();
            rowinfo["data"] = list();
            ...
            output = func.BuildOutput(this, @"~\KELENGKAPANPBJ_list.aspx", smarty);
    ...
    private void AddDisplayGridAttributes()
    {
        if(display_grid)
        {
            ...
            grid_block["begin"] = "<form method=\"POST\" action=\"KELENGKAPANPBJ_list.aspx\" name=\"frmAdmin\" id=\"frmAdmin\">" +
        ...
        smarty.Add("recordspp_attrs","onchange=\"javascript: document.location='KELENGKAPANPBJ_list.aspx?pagesize='+this.options[this.selectedIndex].value;\"");
    ...
    private void AddMasterDetailInfo()
    {
        ...
        //	include proper masterlist.aspx code
	        ...
	        string master = PBJMasterList.CreateMasterTableInfo("KELENGKAPANPBJ", keys, this);
        ...
        //	include proper masterlist.aspx code
            string[] keys = new string[1];
            keys[1 - 1] = (string)this.Session[strTableName + "_masterkey1"];
	        string master = KELENGKAPANMasterList.CreateMasterTableInfo("KELENGKAPANPBJ", keys, this);
	        smarty.Add("showmasterfile",master);
	        smarty.Add("backtomaster_link",true);
	        smarty.Add("mastertable_short","KELENGKAPAN");
        }
    }
    ...
    private void AddLinkAttributes()
    {
	    ...
	    smarty.Add("printlink_attrs","onclick=\"window.open('KELENGKAPANPBJ_print.aspx','wPrint');return false;\"");
	    smarty.Add("printalllink_attrs","onclick=\"window.open('KELENGKAPANPBJ_print.aspx?all=1','wPrint');return false;\"");
	    smarty.Add("export_link", allow_export);
	    smarty.Add("exportlink_attrs","onclick=\"window.open('KELENGKAPANPBJ_export.aspx','wExport');return false;\"");
		...
		"return true;" +
	    "document.forms.frmAdmin.action='KELENGKAPANPBJ_print.aspx';" +
	    "document.forms.frmAdmin.target='_blank';" +
	    "document.forms.frmAdmin.submit(); " +
	    "document.forms.frmAdmin.action='KELENGKAPANPBJ_list.aspx'; " +
	    ...
	    "if(!$('input[@type=checkbox][@checked][@name^=selection]').length)" +
		    "return true;" +
	    "document.forms.frmAdmin.action='KELENGKAPANPBJ_export.aspx';" +
	    "document.forms.frmAdmin.target='_blank';" +
	    "document.forms.frmAdmin.submit(); " +
	    "document.forms.frmAdmin.action='KELENGKAPANPBJ_list.aspx';  " +
	    "document.forms.frmAdmin.target='_self';\"");
	    ...
	    smarty.Add("addlink_attrs","onClick=\"window.location.href='KELENGKAPANPBJADD.aspx?masterkey1="+Request.QueryString["masterkey1"]+"'\"");
	    smarty.Add("inlineaddlink_attrs","href=\"KELENGKAPANPBJ_add.aspx\" onclick=\"return inlineAdd(newrecord_id++);\"");
        ...
        smarty.Add("KODEBPJ_fieldheadercolumn",true);
        smarty.Add("KODEBPJ_fieldcolumn",true);
        smarty.Add("KODEBPJ_fieldfootercolumn",true);
        smarty.Add("KODEKELENGKAPAN_fieldheadercolumn",true);
        smarty.Add("KODEKELENGKAPAN_fieldcolumn",true);
        smarty.Add("KODEKELENGKAPAN_fieldfootercolumn",true);
        smarty.Add("TANGGALDITERIMA_fieldheadercolumn",true);
        smarty.Add("TANGGALDITERIMA_fieldcolumn",true);
        smarty.Add("TANGGALDITERIMA_fieldfootercolumn",true);
        smarty.Add("PENERIMAKELENGKAPAN_fieldheadercolumn",true);
        smarty.Add("PENERIMAKELENGKAPAN_fieldcolumn",true);
        smarty.Add("PENERIMAKELENGKAPAN_fieldfootercolumn",true);
        	
                display_grid = allow_search && rowsfound;

        smarty.Add("asearch_link",allow_search);
        smarty.Add("asearchlink_attrs","onclick=\"window.location.href='KELENGKAPANPBJ_search.aspx';return false;\"");
        smarty.Add("import_link",allow_import);
        smarty.Add("importlink_attrs","onclick=\"window.location.href='KELENGKAPANPBJ_import.aspx';return false;\"");
    ...
    private void BuildForm()
    {
	    ...
	    for(int i = 0; i < collection.Count; ++ i)
        {
            ...
            //	key fields
	            ...
	            string copylink="";
	            string keylink="";
	            keyblock +=  this.Server.UrlEncode(collection[i].KODEBPJ.ToString());
	            editlink += "editid1=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEBPJ.ToString()));
	            copylink +="copyid1=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEBPJ.ToString()));
	            keylink +="&key1=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEBPJ.ToString()));
	            keyblock +=  "&" +  this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString());
	            editlink += "&editid2=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString()));
	            copylink +="&copyid2=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString()));
	            keylink +="&key2=" + Control.HTMLEncodeSpecialChars(this.Server.UrlEncode(collection[i].KODEKELENGKAPAN.ToString()));

	            record["editlink_attrs"]="href=\"KELENGKAPANPBJ_edit.aspx?" + editlink + "\" id=\"editlink" + recno.ToString() + "\"";
	            record["inlineeditlink_attrs"]= "href=\"KELENGKAPANPBJ_edit.aspx?" + editlink + "\" onclick=\"return inlineEdit('" + recno.ToString() + "','" + editlink + "');\" id=\"ieditlink" + recno.ToString() + "\"";
	            record["copylink_attrs"]="href=\"KELENGKAPANPBJ_add.aspx?" + copylink + "\" id=\"copylink" + recno.ToString() + "\"";
	            record["viewlink_attrs"]="href=\"KELENGKAPANPBJ_view.aspx?"  + editlink + "\" id=\"viewlink" + recno.ToString() + "\"";
	            record["checkbox_attrs"]="name=\"selection[]\" value=\"" + keyblock + "\" id=\"check" + recno.ToString() + "\"";

            string value;
            value = string.Empty;
    //	KODEBPJ - 
            Control control_KODEBPJ = new Control("KODEBPJ", collection[i].KODEBPJ, false, smarty, this.Request, builder, MODE.MODE_LIST);
	                        //func.PopulateLookupFields(control_KODEBPJ.FieldInfo);
			    value=func.GetLookupValue(control_KODEBPJ.FieldInfo);
                control_KODEBPJ.Value = value;
			    record["KODEBPJ_value"]=value;
            value = string.Empty;
    //	KODEKELENGKAPAN - 
            Control control_KODEKELENGKAPAN = new Control("KODEKELENGKAPAN", collection[i].KODEKELENGKAPAN, false, smarty, this.Request, builder, MODE.MODE_LIST);
	                        //func.PopulateLookupFields(control_KODEKELENGKAPAN.FieldInfo);
			    value=func.GetLookupValue(control_KODEKELENGKAPAN.FieldInfo);
                control_KODEKELENGKAPAN.Value = value;
			    record["KODEKELENGKAPAN_value"]=value;
            value = string.Empty;
    //	TANGGALDITERIMA - Short Date
            Control control_TANGGALDITERIMA = new Control("TANGGALDITERIMA", collection[i].TANGGALDITERIMA, false, smarty, this.Request, builder, MODE.MODE_LIST);
			    ...
			    record["TANGGALDITERIMA_value"]=value;
            value = string.Empty;
    //	PENERIMAKELENGKAPAN - 
            Control control_PENERIMAKELENGKAPAN = new Control("PENERIMAKELENGKAPAN", collection[i].PENERIMAKELENGKAPAN, false, smarty, this.Request, builder, MODE.MODE_LIST);
			    ...
			    record["PENERIMAKELENGKAPAN_value"]=value;
			    record["show"]=true;
    ...
    private void GetData()
    {
        ...
        {
            collection = new Data.KELENGKAPANPBJCollection();
            numrows = 0;
        }
        else
        {
        ...
        if(allow_search)
        {
	        ...
	        else
	        {
	            ...
	            if(maxpages > 1)
	            {
                    ...
                    pagination += "{window.location='KELENGKAPANPBJ_list.aspx?goto=' + nPageNumber;}</script>";
        ...
        foreach(string val in selected_recs)
        {
                        ...
                        if(!abortDeleting)
            {
                                if(2 > 1)
                {
					...
					// delete record
					ssql = "delete from kelengkapanpbj where kodebpj='"+Convert.ToString(this.Server.UrlDecode(arr[0]).Trim())+"' and kodekelengkapan='"+Convert.ToString(this.Server.UrlDecode(arr[1]).Trim())+"';";
					strSql.Append(ssql);
                ...
                {
                                    Data.KELENGKAPANPBJ.Destroy(val);
                }
                            }
        }
    ...
    private void ProcessSessionVariables()
    {
        ...
        smarty.Add("KODEBPJ_orderlinkattrs", "href=\"KELENGKAPANPBJ_list.aspx?orderby=aKODEBPJ\"");
        smarty.Add("KODEBPJ_fieldheader", true);
        smarty.Add("KODEKELENGKAPAN_orderlinkattrs", "href=\"KELENGKAPANPBJ_list.aspx?orderby=aKODEKELENGKAPAN\"");
        smarty.Add("KODEKELENGKAPAN_fieldheader", true);
        smarty.Add("TANGGALDITERIMA_orderlinkattrs", "href=\"KELENGKAPANPBJ_list.aspx?orderby=aTANGGALDITERIMA\"");
        smarty.Add("TANGGALDITERIMA_fieldheader", true);
        smarty.Add("PENERIMAKELENGKAPAN_orderlinkattrs", "href=\"KELENGKAPANPBJ_list.aspx?orderby=aPENERIMAKELENGKAPAN\"");
        smarty.Add("PENERIMAKELENGKAPAN_fieldheader", true);
        ...
        if(tmp_orderby != null)
        {
	        ...
	        smarty[Control.GoodFieldName(order_field) + "_orderlinkattrs"] = "href=\"KELENGKAPANPBJ_list.aspx?orderby=" + dir + Control.GoodFieldName(order_field) + "\"";
    ...
    private void Body()
    {
        ...
        "<form name=\"frmSearch\" method=\"GET\" action=\"KELENGKAPANPBJ_list.aspx\">" + 
    ...
    private string GetIncludes()
    {
	    ...
	    includes.Append("var INLINE_EDIT_TABLE='KELENGKAPANPBJ_edit.aspx';\r\n");
	    includes.Append("var INLINE_ADD_TABLE='KELENGKAPANPBJ_add.aspx';\r\n");
	    includes.Append("var INLINE_VIEW_TABLE='KELENGKAPANPBJ_view.aspx';\r\n");
	    includes.Append("var SUGGEST_TABLE='KELENGKAPANPBJ_searchsuggest.aspx';\r\n");
	    includes.Append("var MASTER_PREVIEW_TABLE='KELENGKAPANPBJ_masterpreview.aspx';\r\n");
        includes.Append("\n</script>\n");
        ...
        private void ProcessMasterTableOptions()
    {
        ...
        else
        {
            ...
            if(mtable=="KELENGKAPAN")
            {
	            ...
	            smarty.Add("mastertable_block", true);
                smarty.Add("backtomasterlink_attrs","href=\"KELENGKAPAN_list.aspx?a=return\"");
            }
    }
