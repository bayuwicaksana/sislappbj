...
public partial class CPENGGUNA_Fulltext : AspNetRunnerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            BuildBody();
            output.Append(func.BuildOutput(this, @"~\PENGGUNA_fulltext.aspx", smarty));
                }
            DisplayCloseWindow();
        }
    ...
    {
        keys["KODEPENGGUNA"] = Request["key1"];
