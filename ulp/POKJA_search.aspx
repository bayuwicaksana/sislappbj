<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="POKJA_Search.aspx.cs" Inherits="CPOKJA_Search" %>-->
<html>
<head>
<title>POKJA: Advanced search page</title>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">KODE POKJA</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEPOKJA_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEPOKJA}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEPOKJA_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEPOKJA">
	{$KODEPOKJA_editcontrol1}
	</span>&nbsp;</td>
</tr>
...
<tr>
	...
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$DESKRIPSSI_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_DESKRIPSSI}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$DESKRIPSSI_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_DESKRIPSSI">
	{$DESKRIPSSI_editcontrol1}
	</span>&nbsp;</td>
</tr>
