<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="SKPD_Search.aspx.cs" Inherits="CSKPD_Search" %>-->
<html>
<head>
<title>SKPD: Advanced search page</title>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">KODE SKPD</td>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">ALAMAT</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$ALAMAT_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_ALAMAT}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$ALAMAT_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_ALAMAT">
	{$ALAMAT_editcontrol1}
	</span>&nbsp;</td>
</tr>
