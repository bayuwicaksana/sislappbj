...
public partial class CKELOMPOKPENGGUNA_Add : AspNetRunnerPage 
{
    ...
    private void BuildForm()
    {
        ...
        if(RequestAction == "added")
        {
	        ...
	        showDetailKeys["dbo.PENGGUNA"] = masterquery;
    ...
    private void BuildBody()
    {
	    ...
	    if(inlineedit != ADD_MODE.ADD_ONTHEFLY)
	    {
		    ...
		    body["begin"] = includes + 
		    "<form name=\"editform\" encType=\"multipart/form-data\" method=\"post\" action=\"KELOMPOKPENGGUNA_add.aspx\" " + onsubmit + ">" +
	    ...
	    else
	    {
		    ...
		    body["begin"]= "<form name=\"editform" + (string)Request["id"] + "\" encType=\"multipart/form-data\" method=\"post\" action=\"KELOMPOKPENGGUNA_add.aspx\" " + onsubmit + " target=\"flyframe" + (string)Request["id"] + "\">" +
		    "<input type=hidden name=\"a\" value=\"added\">" + 
    ...
    private void Init()
    {
        ...
        if(inlineedit == ADD_MODE.ADD_INLINE)
        {
	        templatefile = "KELOMPOKPENGGUNA_inline_add.aspx";
        }
        else
        {
	        templatefile = "KELOMPOKPENGGUNA_add.aspx";
        }
    }
