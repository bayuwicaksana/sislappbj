<!--<%@ Page Language="c#" AutoEventWireup="true" CodeFile="ASSIGNMENT_Search.aspx.cs" Inherits="CASSIGNMENT_Search" %>-->
<html>
<head>
<title>ASSIGNMENT: Advanced search page</title>
...
ASSIGNMENT - Advanced search</div>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">NAMA ANGGOTA ULP</td>
...
<tr>
	<td class=editshade_b style="padding-left:15px;">PENGADAAN BARANG JASA</td>
	<td align=center class=editshade_lb style="padding-left:10px;"><input type=checkbox {$KODEPBJ_notbox}></td>
	
	<td class=editshade_lb style="padding-left:10px;">{$searchtype_KODEPBJ}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;">{$KODEPBJ_editcontrol}</td>
	<td width=270 class=editshade_lb style="padding-left:10px;"><span id="second_KODEPBJ">
	{$KODEPBJ_editcontrol1}
	</span>&nbsp;</td>
</tr>
